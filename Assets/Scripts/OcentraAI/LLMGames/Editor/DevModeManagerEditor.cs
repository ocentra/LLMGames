...
namespace OcentraAI.LLMGames.ThreeCardBrag.Manager
{
    ...
    public class DevModeManagerEditor : OdinEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            Manager.TrumpDevCard.Suit = (Suit)EditorGUILayout.EnumPopup(Manager.TrumpDevCard.Suit);
            Manager.TrumpDevCard.Rank = (Rank)EditorGUILayout.EnumPopup(Manager.TrumpDevCard.Rank);
        ...
        private void DrawDevHand(DevCard[] hand, GUIStyle combinedStyle)
        {
            ...
            {
                GUILayout.BeginHorizontal();
                devCard.Suit = (Suit)EditorGUILayout.EnumPopup(devCard.Suit);
                devCard.Rank = (Rank)EditorGUILayout.EnumPopup(devCard.Rank);
