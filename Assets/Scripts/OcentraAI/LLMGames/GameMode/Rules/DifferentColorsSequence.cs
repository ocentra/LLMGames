    ...
    public class DifferentColorsSequence : BaseBonusRule
    {
        ...
        public override bool Evaluate(Hand hand, out BonusDetail bonusDetail)
        {
            ...
            if (GameMode.UseTrump)
            {
                ...
                {
                    List<Card> nonTrumpCards = hand.Cards.Where(c => c != trumpCard).ToList();
        ...
        private BonusDetail CalculateBonus(Hand hand, bool isTrumpAssisted)
        {
            ...
            if (isTrumpAssisted)
            {
                ...
                Hand orderedHand = new Hand(hand.Cards.OrderBy(card => card.GetRankValue()));
                Card trumpCard = GetTrumpCard();
        ...
        public override string[] CreateExampleHand(int handSize, string trumpCard = null, bool coloured = true)
        {
            ...
            Suit[] redSuits = { Suit.Hearts, Suit.Diamonds };
            Suit[] blackSuits = { Suit.Spades, Suit.Clubs };
            ...
            for (int i = 0; i < handSize; i++)
            {
                ...
                else
                {
                    ...
                    Suit randomSuit = currentSuits[UnityEngine.Random.Range(0, 2)];
