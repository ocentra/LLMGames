    ...
    public class TrumpOfAKind : BaseBonusRule
    {
        ...
        public override bool Evaluate(List<Card> hand, out BonusDetail bonusDetail)
        {
            ...
            if (trumpCards.Count == 4 && hand.Count > 4) // case 5 to 9 card game
            {
                ...
                bonusDetail = CalculateBonus(remainingCards);
                return true;
            }
        ...
        private BonusDetail CalculateBonus(List<Card> hand,List<Card> remainingCards = null)
        {
            ...
            if (remainingCards != null)
            {
                ...
                else if (IsSequence(remainingCards) && IsSameColorAndDifferentSuits(remainingCards))
                {
                    ...
                    additionalBonus += GameMode.TrumpBonusValues.SameColorBonus;
                }
                ...
                else if (remainingCards.Count == 1 && IsNOfAKind(remainingCards, Rank.A, 1)) // in 5 card game 4 trump remaining is 1
                {
                    ...
                    additionalBonus += GameMode.TrumpBonusValues.HighCardBonus;
                }
            }
