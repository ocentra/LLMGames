    ...
    public class ThreeCardGameMode : GameMode
    {
        ...
        protected override void InitializeGameRules()
        {
            ...
            GameRules.Player = $"{GameName} Rules:{System.Environment.NewLine}" +
                               ...
                               $"12. Royal Flush: Three cards in sequence of the same suit, starting from A. Example: {Card.GetRankSymbol(Suit.Spades, Rank.A)}, {Card.GetRankSymbol(Suit.Spades, Rank.K)}, {Card.GetRankSymbol(Suit.Spades, Rank.Q)}{System.Environment.NewLine}" +
                               ...
                               $"17. High Card: When no other hand is achieved, the highest card plays. Example: {Card.GetRankSymbol(Suit.Spades, Rank.A)}, {Card.GetRankSymbol(Suit.Diamonds, Rank.Seven)}, {Card.GetRankSymbol(Suit.Clubs, Rank.Four)} (A high){System.Environment.NewLine}" +
