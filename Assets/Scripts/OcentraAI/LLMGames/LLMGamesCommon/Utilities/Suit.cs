...
namespace OcentraAI.LLMGames
{
    ...
    public class Suit : IComparable<Suit>
    {
        ...
        public static Suit None = new Suit(0, "None", "N");
        public static Suit Heart = new Suit(1, "Heart", "♥");
        public static Suit Diamond = new Suit(2, "Diamond", "♦");
        public static Suit Club = new Suit(3, "Club", "♣");
        public static Suit Spade = new Suit(4, "Spade", "♠");
        ...
        [ShowInInspector] public string Symbol => symbol;
        ...
        private static List<Suit> InitializeAllSuits()
        {
            ...
            FieldInfo[] fields =
                typeof(Suit).GetFields(BindingFlags.Public | BindingFlags.Static | BindingFlags.DeclaredOnly);
        ...
        public static List<Suit> GetStandardSuits()
        {
            ...
            if (Heart != None)
            {
                standardSuits.Add(Heart);
            }

            if (Diamond != None)
            {
                standardSuits.Add(Diamond);
            }

            if (Club != None)
            {
                standardSuits.Add(Club);
            }

            if (Spade != None)
            {
                standardSuits.Add(Spade);
            }
