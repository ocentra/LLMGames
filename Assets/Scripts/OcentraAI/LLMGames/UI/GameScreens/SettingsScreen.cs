...
namespace OcentraAI.LLMGames.Screens
{
    public class SettingsScreen : UIScreen<SettingsScreen>
    {
        ...
        [ShowInInspector] [Required] public GameObject GeneralSettingsTab { get; private set; }

        [ShowInInspector] [Required] public GameObject LLMSettingsTab { get; private set; }

        [ShowInInspector] [Required] public GameObject SkinSettingsTab { get; private set; }

        [ShowInInspector] [Required] public GameObject CardSettingsTab { get; private set; }

        [ShowInInspector] [Required] public List<Button> TabButtons { get; private set; } = new List<Button>();

        [ShowInInspector] [Required] public Slider MusicVolumeSlider { get; private set; }

        [ShowInInspector] [Required] public Slider SFXVolumeSlider { get; private set; }

        [ShowInInspector] [Required] public Toggle FullscreenToggle { get; private set; }

        [ShowInInspector] [Required] public TMP_Dropdown ResolutionDropdown { get; private set; }

        [ShowInInspector] [Required] public TMP_Dropdown LLMModelDropdown { get; private set; }

        [ShowInInspector] [Required] public Button ApplyButton { get; private set; }

        [ShowInInspector] [Required] public Button BackButton { get; private set; }


        [ShowInInspector] [Required] public Button GeneralTabButton { get; private set; }

        [ShowInInspector] [Required] public Button LLMTabButton { get; private set; }

        [ShowInInspector] [Required] public Button SkinTabButton { get; private set; }

        [ShowInInspector] [Required] public Button CardTabButton { get; private set; }
        ...
        private void PopulateResolutionDropdown()
        {
            ...
            ResolutionDropdown.value =
                options.IndexOf(Screen.currentResolution.width + " x " + Screen.currentResolution.height);
        ...
        private void PopulateLLMModelDropdown()
        {
            ...
            LLMModelDropdown.AddOptions(new List<string>
            {
                "GPT-3.5",
                "GPT-4",
                "GPT4-O",
